...
Run Instructions
The user should make sure to download the pickle, requests, and bs4 modules. Do this by opening a terminal in the code editor or terminal application in the laptop, and running pip install [module name]. Then run test.py to make sure the csv files are properly updated before running main.py to start the game.
